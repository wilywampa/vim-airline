...
function! airline#themes#tomorrow#refresh()
  ...
  let s:V1 = airline#themes#get_highlight2(['Normal', 'bg'], ['Special', 'fg'], 'bold')
  let s:V2 = airline#themes#get_highlight2(['Special', 'fg'], ['Normal', 'bg'])
  let s:V3 = s:N3
  ...
  let s:R1 = airline#themes#get_highlight2(['Normal', 'bg'], ['Constant', 'fg'], 'bold')
  let s:R2 = airline#themes#get_highlight2(['Constant', 'fg'], ['Normal', 'bg'])
  let s:R3 = s:N3
