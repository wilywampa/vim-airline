...
function! airline#themes#tomorrow#refresh()
  ...
  let s:R2 = s:N2
  let s:R3 = s:N3
  let g:airline#themes#tomorrow#palette.visual = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
  ...
  let s:V3 = s:N3
  let g:airline#themes#tomorrow#palette.replace = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
